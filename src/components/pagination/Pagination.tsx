...
export const Pagination = (props: PaginationProps) => {
  ...
  const classNames = {
    arrowButton: clsx(styles.pageStyle, styles.arrowButtonsStyle),
  }
      ...
      <div>
        ...
        >
          <ArrowLeft
            ...
            className={clsx(styles.arrowStyle)}
          />
        </button>
        {mappedPageNumbers.map((el, i) => (
          <button
            ...
            className={clsx(
              styles.pageStyle,
              el === currentPage && styles.activePageStyle,
              el === DOTS && styles.dotsStyle
            )}
            onClick={() => {
              if (typeof el === 'number') onCurrentPageChange(el)
            }}
            disabled={el === DOTS}
          >
            {el}
